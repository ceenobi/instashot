...
export function Component() {
  ...
  const path = location.pathname === `/profile/${username}/following/connects`;
  ...
  return (
    <>
      <MetaArgs title={`@${username} following`} description="Profile page" />
      <Modal
        isOpen={isOpen}
        id="followingModal"
        title="Following"
...
Component.displayName = "Following";
